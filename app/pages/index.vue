...
const dashboardLink = computed(() => role.value ? getRedirectForRole(role.value) : '/login')
...
// Active preview tab for interactive demo
const activeTab = ref<'pos' | 'reservations' | 'analytics' | 'inventory'>('pos')
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-3xl mx-auto space-y-6">
          ...
          <div class="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              @click="goRegister"
              class="w-full sm:w-auto h-11 px-5 rounded-md bg-[#7B5A50] text-white font-medium text-sm hover:bg-[#65463d] transition flex items-center justify-center gap-2"
            >
              <span>Create Account</span>
            ...
            <button
              @click="goLogin"
              class="w-full sm:w-auto h-11 px-5 rounded-md bg-white text-[#2d201b] border border-gray-300 hover:border-[#7B5A50] font-medium text-sm hover:bg-[#FFF8EA] transition flex items-center justify-center gap-2"
            >
        ...
        <!-- Platform Demo Section Placeholder -->
        <div id="demo" class="scroll-mt-24 mt-14 max-w-5xl mx-auto rounded-2xl border-2 border-dashed border-[#7B5A50]/30 bg-white p-12 text-center shadow-sm relative overflow-hidden">
          <!-- 
           INSERT DIRI ANG PLATFORM DEMO na NAVBAr
          -->
          <div class="max-w-md mx-auto space-y-4">
            <div class="w-16 h-16 rounded-full bg-[#7B5A50]/10 text-[#7B5A50] mx-auto flex items-center justify-center">
              <Icon name="heroicons:presentation-chart-line" class="w-8 h-8" />
            </div>
            <h3 class="text-xl font-bold text-[#2d201b]">Platform Demo Placeholder</h3>
            <p class="text-sm text-[#5A4841] leading-relaxed">
              This area is ready for your final platform preview, video demo, or interactive component.
            </p>
            <div class="pt-2">
              <span class="inline-block px-4 py-1.5 text-xs font-mono text-[#7B5A50] bg-[#7B5A50]/10 rounded-md border border-[#7B5A50]/20 font-semibold">
                &lt;!-- Insert Demo Component / Content Here --&gt;
              </span>
            </div>
          </div>
          <!-- ================================================================= -->
    ...
    <section id="how-it-works" class="scroll-mt-24 py-20 lg:py-28 bg-[#FDFBF7] border-b border-[#7B5A50]/10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 text-center flex justify-center">
          <button
            @click="goRegister"
            class="h-11 px-5 rounded-md bg-[#7B5A50] text-white font-medium text-sm hover:bg-[#65463d] transition flex items-center justify-center gap-2"
          >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="rounded-3xl bg-gradient-to-r from-[#7B5A50] via-[#65463d] to-[#5C3F37] text-white p-10 sm:p-16 text-center space-y-8 shadow-2xl relative overflow-hidden">
          ...
          <div class="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
            <button
              @click="goRegister"
              class="w-full sm:w-auto h-11 px-5 rounded-md bg-white text-[#7B5A50] font-medium text-sm hover:bg-[#FFF8EA] transition flex items-center justify-center gap-2"
            >
              <Icon name="heroicons:user-plus" class="w-4 h-4" />
              <span>Create Account</span>
            </button>
            <button
              @click="goLogin"
              class="w-full sm:w-auto h-11 px-5 rounded-md border border-white/40 text-white font-medium text-sm hover:bg-white/10 transition flex items-center justify-center gap-2"
            >
              <Icon name="heroicons:arrow-right-start-on-rectangle" class="w-4 h-4" />
