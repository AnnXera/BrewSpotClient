...
<template>
  <h2 class="font-display text-[18px] min-[360px]:text-[20px] font-bold text-[#3D2B24] mb-3 min-[360px]:mb-4">Documents</h2>

  <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 min-[360px]:gap-5 md:gap-6 mb-5 min-[360px]:mb-6">
